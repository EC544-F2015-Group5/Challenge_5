...
fs.writeFile("C:/Users/HP/Desktop/RSSI_INO/views/data.tsv",s[0].join('\t') +'\r\n'+ s[1].join('\t') , function(err) {
    if(err) {
        return console.log(err);
    }
...
/*arr =[[0,13,5,1],[4,9,5,2],[13,0,5,3]];
//var st = JSON.stringify(arr);
  fs.writeFile("C:/Users/HP/Desktop/RSSI_INO/views/lookuptable.txt",arr , function(err) {
    if(err) {
        return console.log(err);
    }
...
var fs = require("fs");
 arr =[[0,13,5,1],[13,0,5,3]];
// Get content from file
 //var contents = fs.readFileSync("C:/Users/HP/Desktop/RSSI_INO/views/lookuptable.txt");
// Define to JSON type
...
var A = -45.0;
    ...
    for(var i = 0; i<arr.length; i++){
     xa = math.round(math.pow(10.0,(A + arr[i][0])/(10.0*n)),3);
     ya = math.round(math.pow(10.0,(A + arr[i][1])/(10.0*n)),3);
     za = math.round(math.pow(10.0,(A + arr[i][2])/(10.0*n)),3);
...
fs.writeFile("C:/Users/HP/Desktop/RSSI_INO/views/data1.csv",n+','+n, function(err) {
    if(err) {
